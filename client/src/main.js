...
import { EVENT_KEYS } from "./core/events/event-keys.js";
import { events } from "./core/events/events.js";
import { GameLoop } from "./core/game-loop.js";
import GameObject from "./core/game-object.js";
import Input from "./core/input.js";
import { ground, sky, weapons } from "./core/level-objects.js";
...
events.on(EVENT_KEYS.player_item_overlap, player, (item) => {
	player.addChild(item);
});

mainScene.addChild(ground);
mainScene.addChild(player);
mainScene.addChild(weapons);
